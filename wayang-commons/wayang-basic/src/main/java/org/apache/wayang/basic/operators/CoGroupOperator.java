...
/**
 * This operator groups both inputs by some key and then matches groups with the
 * same key. If a key appears in only
 * one of the input datasets, then the according group is matched with an empty
 * group.
 */
public class CoGroupOperator<I0 extends Serializable, I1 extends Serializable, K extends Serializable>
        extends BinaryToUnaryOperator<I0, I1, Tuple2<ArrayList<I0>, ArrayList<I1>>> {
    ...
    protected final TransformationDescriptor<I0, K> keyDescriptor0;

    protected final TransformationDescriptor<I1, K> keyDescriptor1;

    public CoGroupOperator(final FunctionDescriptor.SerializableFunction<I0, K> keyExtractor0,
    ...
    public CoGroupOperator(final TransformationDescriptor<I0, K> keyDescriptor0,
     ...
     */
    public CoGroupOperator(final CoGroupOperator<I0, I1, K> that) {
        super(that);
        this.keyDescriptor0 = that.getKeyDescriptor0();
        this.keyDescriptor1 = that.getKeyDescriptor1();
    }

    public TransformationDescriptor<I0, K> getKeyDescriptor0() {
        return this.keyDescriptor0;
    }

    public TransformationDescriptor<I1, K> getKeyDescriptor1() {
